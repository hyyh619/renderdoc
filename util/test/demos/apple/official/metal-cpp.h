...
// metal-cpp.h
//
// Autogenerated from commit 9c6e07c61e9642cd343988e9f7840543d2132387.
//
...
namespace NS
{
    ...
    using Integer   = std::int64_t; // RD: intptr_t -> int64_t
    using UInteger  = std::uint64_t; // RD: intptr_t -> int64_t
...
public:
        ...
        virtual bool            applicationShouldTerminateAfterLastWindowClosed(class Application *pSender)
        {
            return false;
        }
    };
...
#define _MTL_OPTIONS(type, name)    _NS_ENUM(type, name) // RD: _NS_OPTIONS -> _NS_ENUM
...
namespace MTL
{
    class Drawable; // RD: forward declare Drawable
