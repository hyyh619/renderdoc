...
public:
    ...
    Q_DECL_CONSTEXPR const char* latin1() const Q_DECL_NOTHROW
    {
        return m_data;
    }
    Q_DECL_CONSTEXPR int size() const Q_DECL_NOTHROW
    {
        return m_size;
    }
    Q_DECL_CONSTEXPR const char* data() const Q_DECL_NOTHROW
    {
        return m_data;
    }
    ...
    Q_DECL_CONSTEXPR QLatin1Char operator[](int i) const
    {
        return at(i);
    }
...
#endif
    inline void swap(QString &other) Q_DECL_NOTHROW
    {
        qSwap(d, other.d);
    }
...
public:
    ...
    inline QChar::Script script() const
    {
        return QChar(*this).script();
    }
...
#if QT_DEPRECATED_SINCE(5, 0)
    QT_DEPRECATED char toAscii() const
    {
...
public:
    ...
    QStringRef&operator=(QStringRef &&other) Q_DECL_NOTHROW
    {
        return *this = other;
    }
#endif
    ...
    void truncate(int pos) Q_DECL_NOTHROW
    {
        m_size = qBound(0, pos, m_size);
    }
    ...
    inline void clear()
    {
        m_string = Q_NULLPTR; m_position = m_size = 0;
    }
    ...
    inline bool isNull() const
    {
        return m_string == Q_NULLPTR || m_string->isNull();
    }
...
inline bool operator!=(const QString &lhs, const QStringRef &rhs) Q_DECL_NOTHROW
{
...
inline bool operator==(const QStringRef &lhs, const QString &rhs) Q_DECL_NOTHROW
{
    return rhs == lhs;
}
inline bool operator!=(const QStringRef &lhs, const QString &rhs) Q_DECL_NOTHROW
...
inline bool operator!=(QLatin1String lhs, const QStringRef &rhs) Q_DECL_NOTHROW
{
...
inline bool operator==(const QStringRef &lhs, QLatin1String rhs) Q_DECL_NOTHROW
{
    return rhs == lhs;
}
inline bool operator!=(const QStringRef &lhs, QLatin1String rhs) Q_DECL_NOTHROW
...
inline bool operator==(const QString &lhs, QChar rhs) Q_DECL_NOTHROW
{
    return rhs == lhs;
}
inline bool operator!=(const QString &lhs, QChar rhs) Q_DECL_NOTHROW
...
inline bool operator==(const QStringRef &lhs, QChar rhs) Q_DECL_NOTHROW
{
    return rhs == lhs;
}
inline bool operator!=(const QStringRef &lhs, QChar rhs) Q_DECL_NOTHROW
...
inline bool operator==(QLatin1String lhs, QChar rhs) Q_DECL_NOTHROW
{
    return rhs == lhs;
}
inline bool operator!=(QLatin1String lhs, QChar rhs) Q_DECL_NOTHROW
