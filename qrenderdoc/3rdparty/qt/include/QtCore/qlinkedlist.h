...
#endif
    inline void swap(QLinkedList<T> &other) Q_DECL_NOTHROW
    {
        qSwap(d, other.d);
    }
...
public:
        ...
        iterator&operator=(const iterator &other) Q_DECL_NOTHROW
        {
            i = other.i; return *this;
        }
        iterator(iterator &&other) Q_DECL_NOTHROW : i(other.i) {}
        iterator&operator=(iterator &&other) Q_DECL_NOTHROW
        {
            return *this = other;
        }
#endif
...
public:
        ...
        const_iterator&operator=(const const_iterator &other) Q_DECL_NOTHROW
        {
            i = other.i; return *this;
        }
        const_iterator(const_iterator &&other) Q_DECL_NOTHROW : i(other.i) {}
        const_iterator&operator=(const_iterator &&other) Q_DECL_NOTHROW
        {
            return *this = other;
        }
#endif
