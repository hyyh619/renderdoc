...
struct Q_CORE_EXPORT    QMapNodeBase
{
    ...
    {
        return const_cast<QMapNodeBase*>(const_cast<const QMapNodeBase*>(this)->nextNode());
    }
    const QMapNodeBase* previousNode() const;
    QMapNodeBase* previousNode()
    {
        return const_cast<QMapNodeBase*>(const_cast<const QMapNodeBase*>(this)->previousNode());
    }
    ...
    QMapNodeBase* parent() const
    {
        return reinterpret_cast<QMapNodeBase*>(p & ~Mask);
    }
    void setParent(QMapNodeBase *pp)
    {
        p = (p & Mask) | quintptr(pp);
    }

    template<typename T>
    static typename std::enable_if<QTypeInfo<T>::isComplex>::type
    callDestructorIfNecessary(T &t) Q_DECL_NOTHROW
    {
        Q_UNUSED(t); t.~T();
    }                                                                       // Q_UNUSED: silence MSVC unused 't' warning
    template<typename T>
    static typename std::enable_if<!QTypeInfo<T>::isComplex>::type
...
struct QMapNode : public QMapNodeBase
{
    ...
    inline QMapNode* leftNode() const
    {
        return static_cast<QMapNode*>(left);
    }
    inline QMapNode* rightNode() const
    {
        return static_cast<QMapNode*>(right);
    }

    inline const QMapNode* nextNode() const
    {
        return reinterpret_cast<const QMapNode*>(QMapNodeBase::nextNode());
    }
    inline const QMapNode* previousNode() const
    {
        return static_cast<const QMapNode*>(QMapNodeBase::previousNode());
    }
    inline QMapNode* nextNode()
    {
        return reinterpret_cast<QMapNode*>(QMapNodeBase::nextNode());
    }
    inline QMapNode* previousNode()
    {
        return static_cast<QMapNode*>(QMapNodeBase::previousNode());
    }
...
struct QMapData : public QMapDataBase
{
    ...
    Node* root() const
    {
        return static_cast<Node*>(header.left);
    }
    ...
    {
        return reinterpret_cast<const Node*>(&header);
    }
    Node* end()
    {
        return reinterpret_cast<Node*>(&header);
    }
    const Node* begin() const
    {
        if (root())
            return static_cast<const Node*>(mostLeftNode);
    ...
    {
        if (root())
            return static_cast<Node*>(mostLeftNode);
...
public:
...
#endif
    inline void swap(QMap<Key, T> &other) Q_DECL_NOTHROW
    {
        qSwap(d, other.d);
    }
    ...
    {
        Q_ASSERT(!isEmpty()); return (constEnd() - 1).key();
    }
    ...
    {
        Q_ASSERT(!isEmpty()); return *(constEnd() - 1);
    }
...
public:
        ...
        Q_DECL_CONSTEXPR inline bool operator==(const const_iterator &o) const
        {
            return i == o.i;
        }
        Q_DECL_CONSTEXPR inline bool operator!=(const const_iterator &o) const
...
public:
    ...
    {
        detach(); return iterator(d->begin());
    }
    inline const_iterator begin() const
    {
        return const_iterator(d->begin());
    }
    ...
    inline iterator end()
    {
        detach(); return iterator(d->end());
    }
    inline const_iterator end() const
    {
        return const_iterator(d->end());
    }
...
#endif
    void swap(QMultiMap<Key, T> &other) Q_DECL_NOTHROW
    {
