...
public:
    ...
    { static int size(const QVector<T> *t)
      {
          return t->size();
      }
    };
    ...
    { static int size(const std::list<T> *t)
      {
          return int(t->size());
      }
    };
...
public:
        ...
        int size() const
        {
            Q_ASSERT(_iterable); return _size(_iterable);
        }

        inline void destroyIter()
        {
            _destroyIter(&_iterator);
        }
...
public:
        ...
        inline void begin()
        {
            _begin(_iterable, &_iterator);
        }
        inline void end()
        {
            _end(_iterable, &_iterator);
        }
        ...
        {
            _advance(&_iterator, i); return *this;
        }
