...
public:
        ...
        {
            val = qToLittleEndian(i); return *this;
        }
...
public:
        ...
        int byteSize() const
        {
            return sizeof(uint) + sizeof(ushort) * d->length;
        }
    ...
    {
public:
        explicit Latin1String(const char *data)
        {
            d = (Data*)data;
        }
        ...
        int byteSize() const
        {
            return sizeof(ushort) + sizeof(char) * (d->length);
        }
        bool isValid(int maxSize) const
        {
