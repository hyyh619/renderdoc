...
struct Q_CORE_EXPORT    QListData
{
    ...
    inline void** at(int i) const Q_DECL_NOTHROW
    {
        return d->array + d->begin + i;
    }
    inline void** begin() const Q_DECL_NOTHROW
    {
        return d->array + d->begin;
    }
    inline void** end() const Q_DECL_NOTHROW
    {
...
public:
        ...
        inline T    &operator[](difference_type j) const
        {
            return i[j].t();
        }
        inline bool operator==(const iterator &o) const Q_DECL_NOTHROW
        {
            return i == o.i;
        }
        inline bool operator!=(const iterator &o) const Q_DECL_NOTHROW
        ...
        inline bool operator<(const iterator &other) const Q_DECL_NOTHROW
        {
            return i < other.i;
        }
        inline bool operator<=(const iterator &other) const Q_DECL_NOTHROW
...
public:
        ...
        inline const T    &operator[](difference_type j) const
        {
            return i[j].t();
        }
        inline bool operator==(const const_iterator &o) const Q_DECL_NOTHROW
