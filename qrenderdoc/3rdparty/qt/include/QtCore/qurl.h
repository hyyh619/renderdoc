...
public:
    ...
    inline QUrlTwoFlags&operator&=(int mask)
    {
        i &= mask; return *this;
    }
    inline QUrlTwoFlags&operator&=(uint mask)
    {
        i &= mask; return *this;
    }
    inline QUrlTwoFlags&operator|=(QUrlTwoFlags f)
    {
        i |= f.i; return *this;
    }
    inline QUrlTwoFlags&operator|=(E1 f)
    {
        i |= f; return *this;
    }
    inline QUrlTwoFlags&operator|=(E2 f)
    {
        i |= f; return *this;
    }
    inline QUrlTwoFlags&operator^=(QUrlTwoFlags f)
    ...
    Q_DECL_CONSTEXPR inline bool testFlag(E1 f) const
    {
        return (i & f) == f && (f != 0 || i == int(f));
    }
    Q_DECL_CONSTEXPR inline bool testFlag(E2 f) const
    {
        return (i & f) == f && (f != 0 || i == int(f));
    }
};
...
public:
    ...
    inline void swap(QUrl &other) Q_DECL_NOTHROW
    {
        qSwap(d, other.d);
    }
