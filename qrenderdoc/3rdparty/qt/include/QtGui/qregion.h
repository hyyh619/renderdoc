...
public:
    ...
    QRegion(QRegion &&other) Q_DECL_NOTHROW
        : d(other.d)
    {
        other.d = const_cast<QRegionData*>(&shared_empty);
    }
...
#endif
    inline void swap(QRegion &other) Q_DECL_NOEXCEPT
    {
        qSwap(d, other.d);
    }
    bool isEmpty() const;
    ...
    const_iterator cbegin() const Q_DECL_NOTHROW
    {
        return begin();
    }
    const_iterator end()    const Q_DECL_NOTHROW;
    const_iterator cend()   const Q_DECL_NOTHROW
    {
        return end();
    }
    ...
    Q_REQUIRED_RESULT inline QRegion translated(const QPoint &p) const
    {
    ...
    Q_REQUIRED_RESULT inline QT_DEPRECATED QRegion unite(const QRegion &r) const
    {
        return united(r);
    }
    Q_REQUIRED_RESULT inline QT_DEPRECATED QRegion unite(const QRect &r) const
    {
        return united(r);
    }
    Q_REQUIRED_RESULT inline QT_DEPRECATED QRegion intersect(const QRegion &r) const
    {
        return intersected(r);
    }
    Q_REQUIRED_RESULT inline QT_DEPRECATED QRegion intersect(const QRect &r) const
    {
        return intersected(r);
    }
    Q_REQUIRED_RESULT inline QT_DEPRECATED QRegion subtract(const QRegion &r) const
    {
        return subtracted(r);
    }
    Q_REQUIRED_RESULT inline QT_DEPRECATED QRegion eor(const QRegion &r) const
    {
        return xored(r);
    }
#endif
