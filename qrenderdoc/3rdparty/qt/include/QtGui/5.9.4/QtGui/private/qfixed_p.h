...
public:
    ...
    Q_DECL_CONSTEXPR static QFixed fromReal(qreal r)
    {
        return fromFixed((int)(r * qreal(64)));
    }
    Q_DECL_CONSTEXPR static QFixed fromFixed(int fixed)
    {
        return QFixed(fixed, 0);
    }                                                                               // uses private ctor

    Q_DECL_CONSTEXPR inline int value() const
    {
        return val;
    }
    ...
    Q_DECL_CONSTEXPR inline int toInt() const
    {
        return (((val) + 32) & - 64) >> 6;
    }
    Q_DECL_CONSTEXPR inline qreal toReal() const
    {
        return ((qreal)val) / (qreal)64;
    }

    Q_DECL_CONSTEXPR inline int truncate() const
    {
        return val >> 6;
    }
    Q_DECL_CONSTEXPR inline QFixed round() const
    {
        return fromFixed(((val) + 32) & - 64);
    }
    Q_DECL_CONSTEXPR inline QFixed floor() const
    {
        return fromFixed((val) & - 64);
    }
    Q_DECL_CONSTEXPR inline QFixed ceil() const
    {
        return fromFixed((val + 63) & - 64);
    }

    Q_DECL_CONSTEXPR inline QFixed operator+(int i) const
    {
        return fromFixed(val + i * 64);
    }
    Q_DECL_CONSTEXPR inline QFixed operator+(uint i) const
    {
        return fromFixed((val + (i << 6)));
    }
    Q_DECL_CONSTEXPR inline QFixed operator+(const QFixed &other) const
    {
    ...
    Q_DECL_CONSTEXPR inline QFixed operator-() const
    {
        return fromFixed(-val);
    }

    Q_DECL_CONSTEXPR inline bool operator==(const QFixed &other) const
    {
    ...
    Q_DECL_CONSTEXPR inline QFixed operator/(int d) const
    {
        return fromFixed(val / d);
    }
    inline QFixed operator/(QFixed b) const
    {
        QFixed    f = *this; return (f /= b);
    }
    inline QFixed operator>>(int d) const
    {
        QFixed    f = *this; f.val >>= d; return f;
    }
    inline QFixed&operator*=(int i)
    {
        val *= i; return *this;
...
private:
    ...
    {
        val = (int)(i * qreal(64)); return *this;
    }
    Q_DECL_CONSTEXPR inline QFixed operator+(qreal i) const
    {
        return fromFixed((val + (int)(i * qreal(64))));
    }
    inline QFixed&operator+=(qreal i)
    {
        val += (int)(i * 64); return *this;
    }
    Q_DECL_CONSTEXPR inline QFixed operator-(qreal i) const
    {
        return fromFixed((val - (int)(i * qreal(64))));
    ...
    {
        val = (int)(val / r); return *this;
    }
    Q_DECL_CONSTEXPR inline QFixed operator/(qreal d) const
    {
        return fromFixed((int)(val / d));
    }
    inline QFixed&operator*=(qreal d)
    {
        val = (int) (val * d); return *this;
    }
    Q_DECL_CONSTEXPR inline QFixed operator*(qreal d) const
    {
        return fromFixed((int) (val * d));
...
Q_DECL_CONSTEXPR inline int qRound(const QFixed &f)
{
    return f.toInt();
}
Q_DECL_CONSTEXPR inline int qFloor(const QFixed &f)
{
    return f.floor().truncate();
}

Q_DECL_CONSTEXPR inline QFixed operator*(int i, const QFixed &d)
{
    return d * i;
}
Q_DECL_CONSTEXPR inline QFixed operator+(int i, const QFixed &d)
...
Q_DECL_CONSTEXPR inline QFixed operator*(uint i, const QFixed &d)
{
    return d * i;
}
Q_DECL_CONSTEXPR inline QFixed operator+(uint i, const QFixed &d)
...
Q_DECL_CONSTEXPR inline bool operator==(const QFixed &f, int i)
{
    return f.value() == i * 64;
}
Q_DECL_CONSTEXPR inline bool operator==(int i, const QFixed &f)
{
    return f.value() == i * 64;
}
Q_DECL_CONSTEXPR inline bool operator!=(const QFixed &f, int i)
...
struct QFixedSize
{
    ...
    Q_DECL_CONSTEXPR QSizeF toSizeF() const
    {
