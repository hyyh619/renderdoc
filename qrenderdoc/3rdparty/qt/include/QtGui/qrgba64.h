...
public:
    ...
    Q_DECL_CONSTEXPR quint16 red()   const
    {
        return quint16(rgba >> RedShift);
    }
    Q_DECL_CONSTEXPR quint16 green() const
    {
        return quint16(rgba >> GreenShift);
    }
    Q_DECL_CONSTEXPR quint16 blue()  const
    {
        return quint16(rgba >> BlueShift);
    }
    Q_DECL_CONSTEXPR quint16 alpha() const
    {
    ...
    Q_DECL_CONSTEXPR quint8 red8()   const
    {
        return div_257(red());
    }
    Q_DECL_CONSTEXPR quint8 green8() const
    {
        return div_257(green());
    }
    Q_DECL_CONSTEXPR quint8 blue8()  const
    {
        return div_257(blue());
    }
    Q_DECL_CONSTEXPR quint8 alpha8() const
    {
...
private:
    static Q_DECL_CONSTEXPR Q_ALWAYS_INLINE quint64 alphaMask()
    {
        return Q_UINT64_C(0xffff) << AlphaShift;
    }

    static Q_DECL_CONSTEXPR Q_ALWAYS_INLINE quint8 div_257_floor(uint x)
    {
        return quint8((x - (x >> 8)) >> 8);
    }
    static Q_DECL_CONSTEXPR Q_ALWAYS_INLINE quint8 div_257(quint16 x)
    {
        return div_257_floor(x + 128U);
    }
    static Q_DECL_CONSTEXPR Q_ALWAYS_INLINE quint16 div_65535(uint x)
    {
