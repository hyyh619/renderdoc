...
public:
    ...
    {
        int    s = intProperty(TableCellRowSpan); if (s == 0)
            s = 1;
    ...
    {
        int    s = intProperty(TableCellColumnSpan); if (s == 0)
            s = 1;
...
public:
    ...
    {
        int    a = intProperty(BlockAlignment); if (a == 0)
            a = Qt::AlignLeft;
...
public:
    ...
    {
        int    cols = intProperty(TableColumns); if (cols == 0)
            cols = 1;
