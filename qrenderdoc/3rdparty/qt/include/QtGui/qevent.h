...
public:
    ...
    inline void setLocalPos(const QPointF &localPosition)
    {
        l = localPosition;
    }

#if QT_DEPRECATED_SINCE(5, 0)
    QT_DEPRECATED inline QPointF posF() const
    {
        return l;
    }
#endif
...
#if QT_DEPRECATED_SINCE(5, 0)
    QT_DEPRECATED inline const QPointF    &hiResGlobalPos() const
    {
        return mPos;
    }
#endif
...
public:
    ...
    Q_ALWAYS_INLINE Q_DECL_CONSTEXPR bool isValid() const Q_DECL_NOTHROW
    {
...
{};                                                  // to prevent instantiation: use QVector instead
...
public:
        ...
        TouchPoint&operator=(const TouchPoint &other)
        {
            if (d != other.d)
            {
                TouchPoint    copy(other); swap(copy);
            }
...
#if QT_DEPRECATED_SINCE(5, 0)
    QT_DEPRECATED inline QTouchEvent::DeviceType deviceType() const
    {
