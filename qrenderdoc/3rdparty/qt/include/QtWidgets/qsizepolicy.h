...
#endif // uniform-init
    QT_SIZEPOLICY_CONSTEXPR Policy horizontalPolicy() const Q_DECL_NOTHROW
    {
        return static_cast<Policy>(bits.horPolicy);
    }
    QT_SIZEPOLICY_CONSTEXPR Policy verticalPolicy() const Q_DECL_NOTHROW
    {
        return static_cast<Policy>(bits.verPolicy);
    }
    ControlType controlType() const Q_DECL_NOTHROW;

    Q_DECL_RELAXED_CONSTEXPR void setHorizontalPolicy(Policy d) Q_DECL_NOTHROW
    {
        bits.horPolicy = d;
    }
    Q_DECL_RELAXED_CONSTEXPR void setVerticalPolicy(Policy d) Q_DECL_NOTHROW
    {
        bits.verPolicy = d;
    }
