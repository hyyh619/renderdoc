...
typedef struct NVPW_Device_RawCounterConfig_Create_Params
{
    /// [in]
    size_t structSize;
    /// [in] assign to NULL
...
} NVPW_Device_RawCounterConfig_Create_Params;
#define NVPW_Device_RawCounterConfig_Create_Params_STRUCT_SIZE NVPA_STRUCT_SIZE(NVPW_Device_RawCounterConfig_Create_Params, pRawCounterConfig)
...
/// This API is deprecated and will be removed in a future release. Use `NVPW_Device_RawCounterConfig_Create`
/// instead.
