...
typedef struct NVPW_VKSC_RawCounterConfig_Create_Params
{
    /// [in]
    size_t structSize;
    /// [in] assign to NULL
...
} NVPW_VKSC_RawCounterConfig_Create_Params;
#define NVPW_VKSC_RawCounterConfig_Create_Params_STRUCT_SIZE NVPA_STRUCT_SIZE(NVPW_VKSC_RawCounterConfig_Create_Params, pRawCounterConfig)

/// Create a raw counter config object
...
/// This API is deprecated and will be removed in a future release. Use `NVPW_VKSC_RawCounterConfig_Create` instead.
...
typedef struct NVPW_VKSC_MetricsEvaluator_Initialize_Params
{
    ...
    /// by 'NVPW_VKSC_MetricsEvaluator_CalculateScratchBufferSize'
    size_t scratchBufferSize;
