...
public:
                         ...
                         static Color White()
                         {
                             return Color::Rgba(0xffffffffU);
                         }
                         static Color Black()
                         {
                             return Color::Rgba(0x000000ffU);
                         }
                         static Color Red()
                         {
                             return Color::Rgba(0xff0000ffU);
                         }
                         static Color Green()
                         {
                             return Color::Rgba(0x00ff00ffU);
                         }
                         static Color Blue()
                         {
                             return Color::Rgba(0x0000ffffU);
                         }
                         static Color Yellow()
                         {
                             return Color::Rgba(0xffff00ffU);
                         }
                         static Color Pink()
                         {
                             return Color::Rgba(0xff00ffffU);
                         }
                         static Color Turquoise()
                         {
                             return Color::Rgba(0x00ffffffU);
                         }
                         static Color Invalid()
                         {
                             return Color::Rgba(0x00000000U);
                         }
                     };
