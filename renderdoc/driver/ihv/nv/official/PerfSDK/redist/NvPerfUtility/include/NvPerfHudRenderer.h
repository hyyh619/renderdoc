...
protected:
                         ...
                         // default empty
                         virtual bool RenderFrameSeparator()
                         {
                             return true;
                         }
                         virtual bool RenderPanelBegin(const Panel&, bool*)  const
                         {
                             return true;
                         }
                         virtual bool RenderPanelEnd(const Panel&) const
                         {
                             return true;
                         }
                         virtual bool RenderSeparator(const Separator&) const
                         {
                             return true;
                         }
                         virtual bool RenderScalarTextBlock(const std::vector<const ScalarText*>&) const
                         {
                             return true;
                         }
                         virtual bool RenderTimePlot(const TimePlot&) const
                         {
                             return true;
                         }
